import { Div, Render, Place } from 'verstak'
import { App } from '../models/App'
import { style } from './Page.css'

export function PageView(app: App, customizeContent?: Render<HTMLDivElement, unknown, Place, void>, customizeRightSide?: Render<HTMLElement, unknown, Place, void>) {
  return (
